...
![La búsqueda alcanza documentos, días del diario y notas a la vez](/img/app/search-light.png)
![La búsqueda alcanza documentos, días del diario y notas a la vez](/img/app/search-dark.png)
...
El tachado y el código en línea están en el menú Formato sin un atajo
predeterminado.
...
| Diccionario | `⌘⇧D` |
| Modo lectura | `⌘E` |
| Modo concentración | `⌘⇧F` |
| Santuario (escritura a pantalla completa) | `⌘⇧↩` |
| Acercar | `⌘+` |
| Alejar | `⌘-` |
| Tamaño real | `⌘0` |
| Activar/desactivar pantalla completa | `⌃⌘F` |

## Navegación

Los atajos de **Ir a** son un acorde: mantén `⌘G`, suelta, y luego pulsa la
segunda tecla.
